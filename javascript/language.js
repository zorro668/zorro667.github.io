...
Quantitative promotion income: 10% of the static income of the community",
		...
		detail: {
			...
			node_icome: "Node Reward",
			samllArea: "Small Reward",
			teamArea: "Team Reward",
			team: "Team Network",
			weight: "Global Network",
			invite: "Invite Reward",
			extend: "Recommend Reward",
			topTitle: "Top Heroes Reward",
			share_title: "Direct Push Top Reward",
			small_title: "Small Aera Top Reward",
...
First place: 45%, second place: 25%, third place: 15%, fourth place: 10%, fifth place: 5%",
            direcRule:"Invited Knight Reward: 1% (take 1% of the new performance of the day)\n\
